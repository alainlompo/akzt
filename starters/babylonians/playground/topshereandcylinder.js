var createScene = function () {
    ...
    // Creating a smaller sphere to place on top of the box
    var topSphere = BABYLON.Mesh.CreateSphere("topSphere", 10.0, 3.0, scene);
    ...
    // Insider cylinder
    //(name, height, diameter, tessellation, scene, updatable)
    var insideCylinder = BABYLON.Mesh.CreateCylinder("insideCylinder", 6, 8, 3, 6, 1, scene, false);
	// Creation of a torus
    ...
    topSphere.position = new BABYLON.Vector3(-10,4,0 ); // Putting our small sphere on top of the cube
	sphere.position = new BABYLON.Vector3(0, 10, 0); // Using a vector
	plan.position.z = 10;                            // Using a single coordinate component
	cylinder.position.z = -10;
    insideCylinder.position.x = 10;                  // Pushing our cylinder in the middle of the torus
	torus.position.x = 10;
	knot.position.y = -10;
