// See also: http://www.babylonjs-playground.com/#07KDQV#1
var createScene = function () {
	...
	grass1.ambientTexture = new BABYLON.Texture("textures/grass.png", scene);
	grass1.diffuseColor = new BABYLON.Color3(1, 0, 0);

    var grass2 = new BABYLON.StandardMaterial("grass2", scene);
	grass2.emissiveTexture = new BABYLON.Texture("textures/grass.png", scene);
