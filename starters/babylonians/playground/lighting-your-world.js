var createScene = function () {
    ...
    var light4 = new BABYLON.PointLight("Omni3", new BABYLON.Vector3(0, 0, 10), scene);
    ...
    // A lightsphere for our new light
    lightSphere3.material = new BABYLON.StandardMaterial("blueGreen", scene);
    lightSphere3.material.diffuseColor = new BABYLON.Color3(0, 0, 0);
    lightSphere3.material.specularColor = new BABYLON.Color3(1, 0, 0);
    lightSphere3.material.emissiveColor = new BABYLON.Color3(0, 1, 1)
    ...
    light4.diffuse = new BABYLON.Color3(1, 0, 1);
    ...
    scene.beforeRender = function () {
        ...
        // We rotate in the Y-Z plan
        light4.position = new BABYLON.Vector3(0, 10 * Math.cos(alpha), 10 * Math.sin(alpha));
